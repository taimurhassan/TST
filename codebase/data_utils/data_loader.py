...
class ImageSegmentationGen:

    def __init__(self, images_path, segs_path, batch_size, 
        n_classes, input_height, input_width, output_height, 
        output_width, do_augment=False):
    ...
    def __next__(self):
        with self.lock:
            img_seg_pairs = get_pairs_from_paths(self.images_path, self.segs_path)
            ...
            for _ in range(self.batch_size):
                ...
                X.append(get_image_array(im, self.input_width,
                                       self.input_height, ordering=IMAGE_ORDERING))
                Y.append(get_segmentation_array(
                    seg, self.n_classes, self.output_width, self.output_height))
